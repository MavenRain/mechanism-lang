...
let shared_members = List.concat_map (fun side -> prefix side core) sides
  ...
  @ ["hcomp"]
let members = prefix "Ops" shared_members
...
let fixture_members = ["Embed"; "Delta"; "FirstIdentityAlpha"; "SecondIdentityBeta"; "pairCode"; "certifiedWhisker"; "rightIdLhs"; "rightIdRhs"; "rightIdLaw"; "rightIdLeftAt"; "rightIdRightAt"; "rightVcompLhs"; "rightVcompRhs"; "rightVcompLaw"; "rightVcompLeftAt"; "rightVcompRightAt"; "rightCongrLhs"; "rightCongrRhs"; "rightCongrLaw"; "rightCongrLeftAt"; "rightCongrRightAt"; "leftIdLhs"; "leftIdRhs"; "leftIdLaw"; "leftIdLeftAt"; "leftIdRightAt"; "leftVcompLhs"; "leftVcompRhs"; "leftVcompLaw"; "leftVcompLeftAt"; "leftVcompRightAt"; "leftCongrLhs"; "leftCongrRhs"; "leftCongrLaw"; "leftCongrLeftAt"; "leftCongrRightAt"]
let negatives = ["false-components"; "one-component"; "missing-left-congruence"; "missing-right-congruence"; "nominal-target"; "wrong-endpoint"]
let paths = ["prelude/cat/category-core.mech"; "prelude/cat/heterogeneous-functor.mech"; "prelude/cat/composable-functors.mech"; "prelude/cat/heterogeneous-nattrans.mech"; "prelude/cat/heterogeneous-whiskering.mech"; "prelude/cat/shared-nattrans.mech"; "prelude/cat/nattrans-laws.mech"; "prelude/cat/whiskering-laws.mech"]

let suite root =
  let* templates = read_all root paths in
  let* fixtures = read_all root ["test/fixtures/prelude/whiskering-laws.mech";
    "test/fixtures/prelude/shared-nattrans-runtime.mech";
    "test/fixtures/prelude/whiskering-laws-runtime.mech"] in
  ...
  let expected_families = ["Path"; "Point"; "SeparateTarget"] @ List.concat_map
    (fun instance -> prefix instance ["Ops_Source"; "Ops_Middle"; "Ops_Target"]) ["Mixed"; "Wide"]
  ...
  let* () = List.fold_left (fun acc (name, (family : Positivity.family)) -> let* () = acc in
    ...
    (Ok ()) families in
  let functions = [("rightIdLeftAt", 200, 2607);
    ("rightIdRightAt", 200, 2607);
    ("rightVcompLeftAt", 200, 2605);
    ("rightVcompRightAt", 200, 2605);
    ("rightCongrLeftAt", 2, 726);
    ("rightCongrRightAt", 2, 726);
    ("leftIdLeftAt", 100, 1307);
    ("leftIdRightAt", 100, 1307);
    ("leftVcompLeftAt", 300, 3107);
    ("leftVcompRightAt", 300, 3107);
    ("leftCongrLeftAt", 300, 2607);
    ("leftCongrRightAt", 300, 2607)] in
  ...
  let directory = "test/neg/whiskering-laws/" in
  ...
  let* failures = List.fold_left (fun acc name -> let* failures = acc in
    ...
    Result.fold (Elab.check_in globals negative)
      ...
      ~error:(fun error ->
        ...
        if String.starts_with ~prefix:expected message then Ok failures
...
let () =
  ...
  Result.fold (suite root)
    ~ok:(fun (entries, families, computations, negatives) ->
      Printf.printf "PRELUDE-WHISKERING-LAWS-OK entries=%d families=%d computations=%d negatives=%d\n"
        entries families computations negatives)
    ~error:(fun message -> Printf.printf "PRELUDE-WHISKERING-LAWS-FAIL %s\n" message; exit 1)
