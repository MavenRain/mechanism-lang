"""Compare components certified by pointwise horizontal laws on three hosts."""
...
GATE = "PRELUDE-HORIZONTAL-LAWS-RUNTIME"
...
SOURCES = [
    ...
    'test/fixtures/prelude/horizontal-laws-runtime.mech',
]


def main():
    if len(sys.argv) != 1:
        print("usage: python3 -I test/horizontal_laws_runtime.py", file=sys.stderr)
        return 64
    ...
    hosts = set()
    compared = set()
    with tempfile.TemporaryDirectory(prefix="mechanism-horizontal-laws-") as directory:
        work = Path(directory)
