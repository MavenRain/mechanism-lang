...
let kind_starts_atom (k : Token.kind) : bool =
  match k with
  | Token.Ident _ | Token.Nat _ | Token.Bytes _ | Token.LParen | Token.Unit
  | Token.KProp | Token.KType | Token.KSort
  ...
  | Token.KPoly | Token.KGroup | Token.KSpecialize | Token.KWhere | Token.Eof ->
      false
...
and zk_of_star (loc : Token.loc) (body : Syntax.t) (rest : Token.t list) :
  ...
  | Syntax.SVar _ | Syntax.SNat _ | Syntax.SProp | Syntax.SType _ | Syntax.SSort _
  | Syntax.SPrim _
