...
leg MED PRENEX-DEPENDENCY-EXPORTS-RUNTIME '^PRENEX-DEPENDENCY-EXPORTS-RUNTIME OK cases=2 hosts=3 mutation=1$' \
  python3 -P $ROOT/test/prenex_runtime.py --dependency-exports
...
leg SLOW TEMPLATE-SYMBOLIC-REUSE-RUNTIME \
  '^TEMPLATE-SYMBOLIC-REUSE-RUNTIME OK cases=4 hosts=3 mutation=1$' \
  python3 -I $ROOT/test/reuse_runtime.py --symbolic
...
leg SLOW PRELUDE-HETEROGENEOUS-LEFT-KAN-RUNTIME \
  '^PRELUDE-HETEROGENEOUS-LEFT-KAN-RUNTIME OK cases=4 hosts=3 mutation=1$' \
  python3 -I $ROOT/test/heterogeneous_left_kan_runtime.py
